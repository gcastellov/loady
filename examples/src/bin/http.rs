...
async fn main() {
    ...
    let test_case = TestCaseBuilder::<InnerContext>
        ...
        .with_load_step("load", Box::new(Scenario::load))    
            .with_stage("first wave", Duration::from_secs(5), Duration::from_secs(1), 15)
            .with_stage("second wave", Duration::from_secs(10), Duration::from_secs(1), 50)
            .with_stage("third wave", Duration::from_secs(5), Duration::from_secs(1), 15)
